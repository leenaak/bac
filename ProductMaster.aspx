<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProductMaster.aspx.vb" Inherits="ProductList" MasterPageFile="~/MasterPage.master" %>
            ...
            <asp:UpdatePanel ID="updItemPanel" runat="server"> 
                <ContentTemplate>
                    <asp:GridView ID="grdProductList" runat="server" AllowPaging="true" AllowSorting="False"  CssClass="requests_list"
                            AutoGenerateColumns="false" DataKeyNames="item_rowid" SkinID="Professional" PageSize="20" RowStyle-CssClass ="row"
...
--%>                           <asp:TemplateField HeaderText="Name" SortExpression="item_name" HeaderStyle-Font-Underline="true">
                           ...
                           <asp:TemplateField HeaderText="Nett" SortExpression="nett_item" HeaderStyle-Font-Underline="true">
                                <ItemTemplate>
                           ...
                           <asp:TemplateField HeaderText="Sell Price" SortExpression="sell_pr" HeaderStyle-Font-Underline="true">
                                <ItemTemplate>
                                    <asp:Label ID="lblsell_pr" runat="server" Width = "100px" Text='<%# Eval("sell_pr") %>'></asp:Label>
                                </ItemTemplate>
                           </asp:TemplateField>
                       </Columns>
