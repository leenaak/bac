<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Invoice_Split_Det_old.aspx.vb" Inherits="Invoice_Split_Det_old" MasterPageFile="~/MasterPage.master" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <center id="imgWait" style="display:none;">Please wait...<img id="Img1" src="images/spinner.gif" runat="server" /></center>
        ...
        <asp:Panel Width="25%" runat="server" ID="pnlSearch" CssClass="grey_border" 
            ...
            <table width="100% border=0">
                <tr><td style="width:400px">Invoice Details</td>
                </tr>                
            </table>
        </asp:Panel>
        <br />
        ...
        <div>
            ...
            <asp:Button ID="Button1" Text="Back" runat="server" CssClass="blue_button" Width="100px"/>
            </div> 
    </div>   
</asp:Content>