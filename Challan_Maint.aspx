<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Challan_Maint.aspx.vb" Inherits="ChallanMaint" MasterPageFile="~/MasterPage.master" %>
    ...
    <center id="imgWait" style="display:none;">Please wait...<img id="Img1" src="images/spinner.gif" runat="server" /></center>
        ...
        <div>
            <div style="float:left;width:600px;height:200px; border:[][1][]">
                <table width="100%"><tr>
                    <td class="lbl_style" style ="width:150px">Challan Date</td>
                    <td><asp:TextBox ID="ch_date" runat="server" Width="100px" CssClass="txtbox_style"></asp:TextBox></td>
                 </tr>
                 <br />
                <tr>
                    <td class="lbl_style" style ="width:150px">Order Ref</td>
                    <td><asp:TextBox ID="txtorderref" runat="server" Width="300px" CssClass="txtbox_style"></asp:TextBox></td>
                 </tr>
                <br />
                 <tr>
                ...
                <asp:Panel ID="pnlreviewed"  Width="100%" runat="server" Visible="FALSE">
                    <asp:UpdatePanel ID="updItemPanel" runat="server"> 
                        <ContentTemplate>
                            ...
                            AutoGenerateColumns="false" DataKeyNames="item_rowid" SkinID="Professional" PageSize="200" RowStyle-CssClass ="row"
        ...
        <div>
                <asp:Panel ID="pnlChallanList"  Width="75%" runat="server" Visible="FALSE">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server"> 
                <ContentTemplate>
                    <asp:Label ID="Label1" runat="server" Text=""></asp:Label>
                    <asp:label ID="lblMessage" MaxLength="10" CssClass="lbl_style" width="300px" runat="server" Text='' />
                    ...
                    <Columns>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblproduct" runat="server" Width = "250px" Text='<%# Eval("product") %>'></asp:Label>
                        </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="lblavlqty" runat="server" Width = "75px" Text='<%# Eval("avl_qty") %>'></asp:Label>
                        </ItemTemplate>
                        </asp:TemplateField>
                ...
                <td><asp:LinkButton ID="btnBack" Text="Return to Challan List" runat="server" Width="150px"></asp:LinkButton></td></tr></table>
        </div> 
    </div>   
